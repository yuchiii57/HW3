...
public class Q1 {
	 ...
	 */
	private static boolean isShuffleWorking(deck1 deck,card1 newCard,card1 newCard2){
		deck.shuffle();
	...
	private static boolean isAllCardsCorrect(ArrayList<card1> allCards,int nDeck){
		//check the output 
		boolean isCorrect=true;;
		HashMap <String,Integer> checkHash=new HashMap<String,Integer>();
		for(card1 card:allCards){
			card1.Suit suit= card.getSuit();
